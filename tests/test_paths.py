...
def test_prj_dir_finds_pyproject(tmp_path):
    ...
    result = xp.prj_dir(script)
    assert result == root


def test_prj_dir_finds_requirements_txt(tmp_path):
...
def test_prj_dir_finds_setup_py(tmp_path):
...
def test_prj_dir_finds_git(tmp_path):
...
def test_prj_dir_prefers_shallow_marker(tmp_path):
    """Test that prj_dir returns the shallowest parent with a marker"""
...
def test_prj_dir_marker_priority(tmp_path):
    """Test that prj_dir respects marker priority order"""
...
def test_prj_dir_returns_none_if_no_marker(tmp_path):
    """Test that prj_dir returns None when no marker found"""
